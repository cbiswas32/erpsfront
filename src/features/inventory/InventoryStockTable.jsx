...
function InventoryStockTable({ getInventoryStockListAPICall, inventoryList }) {
//   useEffect(() => {
...
//   }, []);
  ...
  const columns = [
    ...
    { field: 'product_name', headerName: 'Product', headerClassName: 'table-header', flex: 3, minWidth: 200 },
    { field: 'unit', headerName: 'Unit', headerClassName: 'table-header', flex: 1, minWidth: 80 },
    { field: 'low_stock_threshold', headerName: 'Low Stock Threshold', headerClassName: 'table-header', flex: 2, minWidth: 100 },
    { field: 'location_name', headerName: 'Location', headerClassName: 'table-header', flex: 2, minWidth: 150 },
    { field: 'quantity', headerName: 'Available Quantity', headerClassName: 'table-header', flex: 2, minWidth: 120 },
